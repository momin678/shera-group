            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('env_key_update.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-3 col-form-label form-check-label">Type</label>
                        <div class="col-md-9">
                    ...
                    <div id="smtp">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL HOST</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL PORT</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL USERNAME</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL PASSWORD</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL ENCRYPTION</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL FROM ADDRESS</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAIL FROM NAME</label>
                            </div>
                            <div class="col-md-9">
                    ...
                    <div id="mailgun">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAILGUN DOMAIN</label>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="form-check-label">MAILGUN SECRET</label>
                            </div>
                            <div class="col-md-9">
