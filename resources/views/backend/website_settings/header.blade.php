				...
				<form action="{{ route('business_settings.sideTopLogo') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
                        ...
                        <div class="col-md-8">
    	                    ...
    	                    <input type="text" name="website_name" class="form-control" placeholder="Website Name" value="{{json_decode(get_setting('website_name'))}}">
                        </div>
                    </div>
					<div class="form-group row">
						...
						<div class="col-md-8">
						    <div>
                              ...
                              <input type="file" name="en_logo" onchange="previewFile(this)" class="form-control" value="{{json_decode(get_setting('en_logo')) }}">
                              @if(json_decode(get_setting('en_logo')))
                                <img height="100px" src="{{asset('images/logo')}}/{{json_decode(get_setting('en_logo'))}}"/>
                              @else
                                <img height="100px"/>
                              @endif
                            </div>
					...
					<div class="form-group row">
						...
						<div class="col-md-8">
                            <div>
                              ...
                              <input type="file" name="bn_logo" onchange="previewFile(this)" class="form-control" value="{{ get_setting('bn_logo') }}">
                              @if(json_decode(get_setting('bn_logo')))
                                <img height="100px" src="{{asset('images/logo')}}/{{json_decode(get_setting('bn_logo'))}}"/>
                              @else
                                <img height="100px"/>
                              @endif
                            </div>
