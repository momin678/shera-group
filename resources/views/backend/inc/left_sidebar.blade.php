    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{activeRoutesLi(['admin.products','product.create', 'product.edit', 'product.index', 'brand.create', 'brand.edit', 'brand.index', 'category.index', 'category.edit', 'category.create','attributes.index', 'attributes.create', 'attributes.edit'])}}">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('admin.products')}}" class="nav-link {{activeRoutesUlLi(['admin.products'])}}">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('website.header')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Header</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('business_settings.home-slider')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Home Slider</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('website.left-sidebar')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Left-sidebar</p>
                </a>
              </li>
